...
export function Sidebar({ screeningMode }: SidebarProps) {
  ...
  return (
    <aside className="w-64 min-h-screen bg-white/[0.03] flex flex-col">
      {/* Logo */}
      ...
      {/* Screening badge */}
      <div className="p-4 mx-3 mb-4 rounded-2xl bg-white/[0.06] shadow-[0_4px_20px_-4px_rgba(0,0,0,0.2)]">
